    ...
    <header className="bg-blue-500 font-poppins">
      <nav className="flex justify-between items-center px-5 py-2 sm:px-7 md:px-12 lg:px-20">
          ...
          <div className="text-2xl text-white group">
            <i class="fa-solid fa-bars">
              <ul className="hidden font-poppins font-normal text-lg bg-blue-500 h-svh absolute left-0 mt-4 pl-4 pr-16 group-hover:flex group-hover:flex-col">
                ...
                <li className="pl-3 py-2">Become a seller</li>
              </ul>
            </i>
          </div>
        </div>
        ...
        <div className="w-2/5 hidden sm:flex">
          <input className="border rounded-l-xl pl-3 focus:shadow-md focus:shadow-blue-800 ease-in-out duration-300 outline-none w-full h-10 py-1" type="text" placeholder="Search for products..." />
        ...
        <div className="w-32 text-lg sm:w-24 md:hidden">
          <ul className="flex justify-between text-white">
            ...
            <li>
            <Link to={"/login"}><li className="text-md py-2 cursor-pointer mr-2 text-center ease-in-out duration-300 hover:font-semibold">Login</li></Link>
            </li>
          </ul>
        </div>

        {/* additional options */}
        <div className="text-md  lg:text-xl hidden md:flex">
          <ul className="flex justify-between items-center text-white w-48">
            <li className="hover:text-blue-700 py-3 ease-in-out duration-200 cursor-pointer group"> Login <FontAwesomeIcon icon={faAngleDown} className="group-hover:rotate-180 duration-300" />
            <ul className="hidden text-blue-500 absolute right-28 lg:right-24 bg-slate-100 mt-3 px-3 lg:px-6 py-2 rounded-lg shadow-xl shadow-blue-800 group-hover:flex group-hover:flex-col">
                <Link to={"/login"}><li className="py-2 w-40 lg:w-56 text-center bg-blue-700 text-white rounded-lg ease-in-out duration-300 hover:font-semibold px-4">Login or signup</li></Link>
                <li className="py-2 text-center ease-in-out duration-300 hover:text-blue-800 hover:font-semibold hover:underline hover:underline-offset-8">Account</li>
                <li className="py-2 text-center ease-in-out duration-300 hover:text-blue-800 hover:font-semibold hover:underline hover:underline-offset-8">Become a seller</li>
                <li className="py-2 text-center ease-in-out duration-300 hover:text-blue-800 hover:font-semibold hover:underline hover:underline-offset-8">Orders</li>
                <li className="py-2 text-center ease-in-out duration-300 hover:text-blue-800 hover:font-semibold hover:underline hover:underline-offset-8">Rewards</li>
                <li className="py-2 text-center ease-in-out duration-300 hover:text-blue-800 hover:font-semibold hover:underline hover:underline-offset-8">Gift cards</li>
              </ul>
            </li>
